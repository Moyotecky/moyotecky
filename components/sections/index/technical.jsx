				...
				<section className={`${about.content} ${about.container}`}>
					<div className={about.copy}>
						...
						<BadgesBlock 
							...
							copy="I deeply enjoy solving problems through code. From the front end all the way to the back end to mobile apps and the APIs in-between. No project is too challenging for me."
							list={tech} 
							block="tech"
							fullContainer="fullContainer" 
							icon="laptop-code"
...
const software = [
	...
	{ key: 'terminal',	name: 'Terminal', 		type: 'devicon' },
